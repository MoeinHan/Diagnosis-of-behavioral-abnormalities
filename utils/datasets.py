...
class WebcamStream:
    ...
    def __init__(self, stream_id=0):
        ...
        self.t = Thread(target=self.update, name='Thread-1',args=())
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=640, stride=32):
        ...
        assert cap.isOpened(), f'Failed to open {self.sources}'
...
def letterbox(img, new_shape=(480, 640), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True, stride=32):
